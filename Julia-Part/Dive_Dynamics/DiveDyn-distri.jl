...
@everywhere function parallel_sol(ii, idxs, loaded, num_init)
    (i,j) = idxs[ii]
...
@time Fractions_coll = pmap(ii -> parallel_sol(ii, idxs, loaded, num_init), 1:length(idxs))
